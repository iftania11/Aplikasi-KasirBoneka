...
public class form_barang extends javax.swing.JFrame {
    ...
    DefaultTableModel tm;
      ...
      public void tampil_table(){
        ...
        new Object[] {"Kode produk","Nama produk","Harga jual","Harga beli","Id kategori","Stok"} );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtkategori, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(54, 54, 54)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btncari, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btntambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntambahActionPerformed
        ...
        ps.setString(5, txtkategori.getText());
    ...
    private void tblbarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblbarangMouseClicked
        ...
        String Id_kategori= (String) tm.getValueAt (i,4);
        txtkategori.setText(Id_kategori);
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        // TODO add your handling code here:
          try{
            PreparedStatement ps = con.prepareStatement ("UPDATE tbl_produk SET nama_produk=?,harga_jual=?,harga_beli=?,id_kategori=?,stok=? WHERE kode_produk=?");
        ps.setString(1, txtnama.getText());
        ps.setString(2, txtjual.getText());
        ps.setString(3, txtbeli.getText());
    ...
    private void btncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncariActionPerformed
        ...
        try
        {
            PreparedStatement s= con.prepareStatement ("{SELECT * from_barang where kode_produk LIKE '%" + btncari.getText().toString()+"%'");
            ResultSet r= s.executeQuery();
            while(r.next())
            {
                Object[] data={
