...
public class form_pengguna extends javax.swing.JFrame {
     ...
     public void connect (){
       ...
       public void tampil_table(){
        ...
        tm = new DefaultTableModel(
            null,
            new Object[] {"Id pengguna","Nama pengguna","Password","Level","Email"}
        );
        tblpengguna.setModel(tm);
        tm.getDataVector().removeAllElements();
        try {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(88, 88, 88)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cblevel, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    String query = "SELECT * FROM tbl_user WHERE id_user = ? OR nama_user = ?";
    PreparedStatement psCheck = con.prepareStatement(query);
    psCheck.setString(1, txtno.getText());
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        // TODO add your handling code here:
           try{
            PreparedStatement ps = con.prepareStatement ("UPDATE tbl_user SET nama_user=?,password=?,level=?,email=? WHERE id_user=?");
